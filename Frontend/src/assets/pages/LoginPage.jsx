      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="text-center mb-10">
          <div className="flex items-center justify-center gap-2 mb-3">
            <span className="bg-cyan-500 text-black text-xs font-bold px-2 py-0.5 rounded">
              ✕
            </span>
            <span className="text-white font-bold tracking-wider text-2xl">
              CODE <span className="text-cyan-400">DOJO</span>
            </span>
          </div>
          <p className="text-gray-500 text-sm">
            Master code through understanding
          </p>
        </div>
          ...
          {isLogin && (
            <>
              ...
              <button
                ...
                className="w-full bg-gray-700 hover:bg-gray-600 text-white py-3 rounded-lg font-bold text-sm transition"
              >
                Login with Auth0
              </button>
            </>
